...
const AuthPage = () => {
  ...
  return (
    <div className={`relative flex items-center justify-center px-4 py-2 ${isLogin ? 'h-screen overflow-hidden' : 'min-h-screen overflow-y-auto'}`}>
      <video
      ...
      <div className="absolute bottom-4 left-4 hidden md:block text-gray-400 text-xs">
